      ...
      <div className="max-w-[675px] lg:w-[675px] px-6 lg:px-0 flex flex-col">
        ...
        <div className="flex items-center mt-18 self-center md:self-start md:mt-auto gap-6 text-neutral-400">
          <a href="https://github.com/mcdojr" target="_blank" title="Github">
            <FontAwesomeIcon
              icon={faGithub}
              className="cursor-pointer text-xl hover:text-white transition-colors duration-100"
            />
          </a>
          <a
            href="https://www.linkedin.com/in/karlbejerano/"
            target="_blank"
            title="LinkedIn"
          >
            <FontAwesomeIcon
          ...
          >
            <FontAwesomeIcon
              icon={faUpwork}
              className="cursor-pointer text-[22px] hover:text-white transition-colors duration-100"
            />
          </a>
